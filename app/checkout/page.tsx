  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card space-y-3">
        ...
        {isSuccess && sent && (<div className="text-sm"><p className="text-green-300">Payment confirmed ✔</p><button className="btn-outline mt-2" onClick={() => clear()}>Clear cart</button></div>)}
      </div>
      <p className="text-xs opacity-70">⚠️ Demo only. Use testnets.</p>
    </div>
  );
}
